            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-80">
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-sm">
                        <li><Link href="#">Ana Laura Lis Oliveira Zenith</Link></li>
                        <li><Link href="#">Eduardo Fernandes Grespi</Link></li>
                        <li><Link href="#">Héricles Robert Mendes</Link></li>
                        <li><Link href="#">João Marcos Landi Sousa</Link></li>
                    </ul>
                </div>
            </div>
        </div>
